                  ...
                  child: GridView.count(
                    ...
                    children: [
                      MenuButton(
                        ...
                        semanticLabel: R.strings.welcomePageArticleSubmission,
                        routeName: RouteName.routeDummyPage,
                        menuTitle: R.strings.welcomePageArticleSubmission,
                      ),
                      MenuButton(
                        icon: Icons.filter_alt,
                        semanticLabel: R.strings.welcomePageFilter,
                        routeName: RouteName.routeDummyPage,
                        menuTitle: R.strings.welcomePageFilter,
                      ),
                      MenuButton(
                        icon: Icons.bookmark,
                        semanticLabel: R.strings.welcomePageBucketList,
                        routeName: RouteName.routeDummyPage,
                        menuTitle: R.strings.welcomePageBucketList,
                      ),
                      MenuButton(
                        icon: Icons.info_outline,
                        semanticLabel: R.strings.welcomePageGeneralInfo,
                        routeName: RouteName.routeGeneralInfoPage,
                        menuTitle: R.strings.welcomePageGeneralInfo,
                      ),
                    ],
                  ),
                )
